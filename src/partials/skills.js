...
const Skills = () => {
    ...
    const getAllCards = () => {
        const apiUrl = 'https://wax.api.atomicassets.io/atomicassets/v1/assets?owner=uxgr2.wam&collection_name=gnomeseries1&page=1&limit=100&order=desc&sort=asset_id'
            ...
            <div className="grid grid-3-3-3-3 centered pt-5 pb-5">
                ...
                <div className="quest-item">
                    <figure className="quest-item-cover liquid" style={{height: "400px!important"}}>
                        <img src="/skills-images/Qmd2mpYuwHtQYQFx4raTdWXYVP6TAJP6FNWP8zfqzkCzMy.gif" alt="cover-01"/>
                    </figure>
